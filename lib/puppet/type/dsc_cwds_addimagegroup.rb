...
Puppet::Type.newtype(:dsc_cwds_addimagegroup) do
  ...
  validate do
      fail('dsc_imagegroup is a required attribute') if self[:dsc_imagegroup].nil?
    end
...
Puppet::Type.type(:dsc_cwds_addimagegroup).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

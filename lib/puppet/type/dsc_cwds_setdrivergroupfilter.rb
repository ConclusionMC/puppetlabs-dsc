...
Puppet::Type.newtype(:dsc_cwds_setdrivergroupfilter) do
...
Puppet::Type.type(:dsc_cwds_setdrivergroupfilter).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

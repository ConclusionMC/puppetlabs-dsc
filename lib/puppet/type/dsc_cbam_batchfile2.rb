...
Puppet::Type.newtype(:dsc_cbam_batchfile2) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC cBAM_BatchFile2 resource type.
    Automatically generated from
    'cBAM/DSCResources/cBAM_BatchFile2/cBAM_BatchFile2.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'cBAM_BatchFile2' end
  def dscmeta_resource_name; 'cBAM_BatchFile2' end
...
Puppet::Type.type(:dsc_cbam_batchfile2).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

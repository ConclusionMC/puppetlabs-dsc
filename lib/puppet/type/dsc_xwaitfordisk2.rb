...
Puppet::Type.newtype(:dsc_xwaitfordisk2) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xWaitForDisk2 resource type.
    Automatically generated from
    'xStorage/Modules/xStorage/DSCResources/MSFT_xWaitForDisk2/MSFT_xWaitForDisk2.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xWaitForDisk2' end
  def dscmeta_resource_name; 'MSFT_xWaitForDisk2' end
...
Puppet::Type.type(:dsc_xwaitfordisk2).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

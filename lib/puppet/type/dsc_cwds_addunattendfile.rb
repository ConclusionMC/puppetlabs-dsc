...
Puppet::Type.newtype(:dsc_cwds_addunattendfile) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC cWDS_AddUnattendFile resource type.
    Automatically generated from
    'cWDS/DSCResources/cWDS_AddUnattendFile/cWDS_AddUnattendFile.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'cWDS_AddUnattendFile' end
  def dscmeta_resource_name; 'cWDS_AddUnattendFile' end
...
Puppet::Type.type(:dsc_cwds_addunattendfile).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

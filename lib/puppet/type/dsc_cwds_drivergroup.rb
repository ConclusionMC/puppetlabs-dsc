...
Puppet::Type.newtype(:dsc_cwds_drivergroup) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC cWDS_DriverGroup resource type.
    Automatically generated from
    'cWDS/DSCResources/cWDS_DriverGroup/cWDS_DriverGroup.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'cWDS_DriverGroup' end
  def dscmeta_resource_name; 'cWDS_DriverGroup' end
...
Puppet::Type.type(:dsc_cwds_drivergroup).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

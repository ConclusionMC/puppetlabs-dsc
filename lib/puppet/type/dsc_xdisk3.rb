...
Puppet::Type.newtype(:dsc_xdisk3) do
  ...
  def dscmeta_resource_friendly_name; 'xDisk3' end
  def dscmeta_resource_name; 'MSFT_xDisk3' end
...
Puppet::Type.type(:dsc_xdisk3).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

...
Puppet::Type.newtype(:dsc_cdhcp_options) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC cDHCP_Options resource type.
    Automatically generated from
    'cDHCP/DSCResources/cDHCP_Options/cDHCP_Options.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'cDHCP_Options' end
  def dscmeta_resource_name; 'cDHCP_Options' end
...
Puppet::Type.type(:dsc_cdhcp_options).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

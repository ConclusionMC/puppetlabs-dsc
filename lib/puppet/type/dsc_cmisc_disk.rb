...
Puppet::Type.newtype(:dsc_cmisc_disk) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC cMisc_Disk resource type.
    Automatically generated from
    'cMisc/DSCResources/cMisc_Disk/cMisc_Disk.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'cMisc_Disk' end
  def dscmeta_resource_name; 'cMisc_Disk' end
...
Puppet::Type.type(:dsc_cmisc_disk).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

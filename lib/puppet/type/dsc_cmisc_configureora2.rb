...
Puppet::Type.newtype(:dsc_cmisc_configureora2) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC cMisc_ConfigureORA2 resource type.
    Automatically generated from
    'cMisc/DSCResources/cMisc_ConfigureORA2/cMisc_ConfigureORA2.schema.mof'
  ...
  validate do
      fail('dsc_tnsname is a required attribute') if self[:dsc_tnsname].nil?
  ...
  def dscmeta_resource_friendly_name; 'cMisc_ConfigureORA2' end
  def dscmeta_resource_name; 'cMisc_ConfigureORA2' end
...
Puppet::Type.type(:dsc_cmisc_configureora2).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

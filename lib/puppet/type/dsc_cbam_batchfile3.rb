...
Puppet::Type.newtype(:dsc_cbam_batchfile3) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC cBAM_BatchFile3 resource type.
    Automatically generated from
    'cBAM/DSCResources/cBAM_BatchFile3/cBAM_BatchFile3.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'cBAM_BatchFile3' end
  def dscmeta_resource_name; 'cBAM_BatchFile3' end
...
Puppet::Type.type(:dsc_cbam_batchfile3).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

...
Puppet::Type.newtype(:dsc_xwaitfordisk3) do
  ...
  def dscmeta_resource_friendly_name; 'xWaitForDisk3' end
  def dscmeta_resource_name; 'MSFT_xWaitForDisk3' end
...
Puppet::Type.type(:dsc_xwaitfordisk3).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do

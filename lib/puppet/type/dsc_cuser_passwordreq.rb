...
Puppet::Type.newtype(:dsc_cuser_passwordreq) do
  ...
  def dscmeta_resource_friendly_name; 'cUser_Passwordreq' end
  def dscmeta_resource_name; 'cUser_Passwordreq' end
  def dscmeta_module_name; 'cUser_Passwordreq' end
...
Puppet::Type.type(:dsc_cuser_passwordreq).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
